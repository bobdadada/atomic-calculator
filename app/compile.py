...
hidden_import = ('sympy.physics.quantum', 'fractions', 'inspect')
exestr = 'pyinstaller -F --clean ' + ' '.join(
    '--hidden-import {}'.format(i) for i in hidden_import) + ' -w {}.py'.format(src_name)
print(exestr)
